...
class PokerGameTest {
    private final ConcretePokerGame pokerGame = new ConcretePokerGame(new PokerConsoleRenderer(), new PlainTextCardsParser(), new ConcreteDealer(new ConcretePokerHandReader()));
